...
![Screenshot of change folders tab](/img/changeFolder.png)
...
![Screenshot of new tabs](/img/tests.png)
...
![Screenshot of "Keyword was not found" alert window](/img/alertWindow.png)
